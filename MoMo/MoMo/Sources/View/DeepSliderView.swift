...
class DeepSliderView: UIView {
    ...
    static func instantiate() -> DeepSliderView? {
        ...
        deepSliderView?.deepPointSlider.setValue(0, animated: false)
        ...
        // deepLineSlider 설정
        deepSliderView?.deepLineSlider.setValue(0, animated: false)
        ...
        // deepLabelSlider 설정
        deepSliderView?.deepLabelSlider.setValue(0, animated: false)
        ...
        deepSliderView?.deepLabelSlider.setThumbImage(deepSliderView?.labelImages[0], for: .normal)
