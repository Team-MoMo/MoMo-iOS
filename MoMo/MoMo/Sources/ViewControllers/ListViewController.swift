...
//            cell.setCell(list: self.receivedData[indexPath.row])
//            cell.quoteSpacing(self.receivedData[indexPath.row].quote)
//            cell.journalView.round(corners: [.topLeft, .bottomLeft], cornerRadius: 20)
//            cell.journaltext(self.receivedData[indexPath.row].journal, self.widthSize)
